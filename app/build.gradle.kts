plugins {
    ...
    // Required if the project is using Kotlin 2.x and compose is enabled
...
dependencies {
    // ✅ REQUIRED for XML Material3 theme + attrs (Theme.Material3.* / colorSurface, etc.)
